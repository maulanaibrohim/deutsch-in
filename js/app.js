...
const grammarDecks = [
{
    ...
    questions: [
        ...
        {
            question: "Ich kenne _____ Lehrer nicht.", // I don’t know the teacher.
            options: ["der", "den", "dem", "des"],
            correct: 1
        },
        {
        ...
        {
            question: "Er sucht _____ Schlüssel.", // He is looking for the keys.
            options: ["die", "der", "den", "dem"],
            correct: 0
        },
        {
